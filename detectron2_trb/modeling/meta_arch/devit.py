...
from detectron2_trb.config import configurable, get_cfg
from detectron2_trb.data.detection_utils import convert_image_to_rgb
from detectron2_trb.structures import ImageList, Instances, Boxes
from detectron2_trb.utils.events import get_event_storage
from detectron2_trb.utils.logger import log_first_n
...
from detectron2_trb.utils.comm import gather_tensors, MILCrossEntropy

from detectron2_trb.layers.roi_align import ROIAlign
from torchvision.ops.boxes import box_area, box_iou

from torchvision.ops import sigmoid_focal_loss

from detectron2_trb.modeling.roi_heads.fast_rcnn import fast_rcnn_inference
from detectron2_trb.modeling.box_regression import Box2BoxTransform
from detectron2_trb.structures import Boxes, Instances
from fvcore.nn import giou_loss, smooth_l1_loss
from detectron2_trb.structures.masks import PolygonMasks
...
class OpenSetDetectorWithExamples(nn.Module):
    ...
    def offline_preprocess_image(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        """
        Normalize, pad and batch the input images. Use detectron2_trb default processing (pixel mean & std).
