...
from detectron2_trb.modeling import meta_arch
from detectron2_trb.modeling.box_regression import Box2BoxTransform
from detectron2_trb.modeling.meta_arch.panoptic_fpn import combine_semantic_and_instance_outputs
from detectron2_trb.modeling.meta_arch.retinanet import permute_to_N_HWA_K
from detectron2_trb.modeling.postprocessing import detector_postprocess, sem_seg_postprocess
from detectron2_trb.modeling.roi_heads import keypoint_head
from detectron2_trb.structures import Boxes, ImageList, Instances, RotatedBoxes
...
def assemble_rcnn_outputs_by_name(image_sizes, tensor_outputs, force_mask_on=False):
    ...
    to detectron2_trb's format (i.e. list of Instances instance).
...
class Caffe2MetaArch(Caffe2Compatible, torch.nn.Module):
    ...
    def __init__(self, cfg, torch_model):
        ...
        Args:
            cfg (CfgNode):
            torch_model (nn.Module): the detectron2_trb model (meta_arch) to be
                converted.
        """
        super().__init__()
    ...
    def get_caffe2_inputs(self, batched_inputs):
        ...
        Args:
            batched_inputs (list[dict]): inputs to a detectron2_trb model
    ...
    def get_outputs_converter(predict_net, init_net):
        ...
        detectron2_trb's standard format.
