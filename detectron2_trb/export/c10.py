...
from detectron2_trb.layers import cat
from detectron2_trb.layers.roi_align_rotated import ROIAlignRotated
from detectron2_trb.modeling import poolers
from detectron2_trb.modeling.proposal_generator import rpn
from detectron2_trb.modeling.roi_heads.mask_head import mask_rcnn_inference
from detectron2_trb.structures import Boxes, ImageList, Instances, Keypoints

from .shared import alias, to_device


"""
This file contains caffe2-compatible implementation of several detectron2_trb components.
"""


class Caffe2Boxes(Boxes):
    """
    Representing a list of detectron2_trb.structures.Boxes from minibatch, each box
