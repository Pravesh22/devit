...
from detectron2_trb.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from detectron2_trb.config import instantiate, LazyCall
...
_CFG_PACKAGE_NAME = "detectron2_trb._cfg_loader"
"""
