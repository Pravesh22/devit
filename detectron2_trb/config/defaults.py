...
# Path (a file path, or URL like detectron2_trb://.., https://..) to a checkpoint file
...
# Cropping type. See documentation of `detectron2_trb.data.transforms.RandomCrop` for explanation.
...
# See detectron2_trb/solver/build.py for LR scheduler options
...
# and access it with:
#
# from detectron2_trb.config import global_cfg
